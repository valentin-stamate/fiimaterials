import {Class, ClassType, Contributor, Material, Roles} from "./models";
...
export class Data {
  static classes: Class[] = [
    ...
    {
      name: 'Techniques of Natural Language Engineering',
      short: 'PLN',
      credits: 6,
      about: '',
      materials: '',
