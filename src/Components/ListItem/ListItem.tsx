...
import MegaIcon from "./../../Assets/mega-icon.svg";
    ...
    return (
        <React.StrictMode>
            ...
            <div className="list-container">
                ...
                <Button className="float-right" variant="dark">Site</Button>
                {/*<object data={MegaIcon} className="mega-icon float-right"/>*/}

                <svg className="mega-icon float-right mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 467 420">
