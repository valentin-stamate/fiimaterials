            ...
            <Card className="list-container" style={{backgroundColor: "#404040"}}>
                <div>
                    ...
                    <span className="right-side">
                        ...
                        {/*<div className="class-rate-number inline ml-1"><b>4.5</b></div>*/}

                        <svg onClick={openMaterialLink} style={{cursor: "pointer"}} className="mega-icon mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 467 420">
                        ...
                        <Button onClick={openLink} variant="dark">Site</Button>
                    </span>
                </div>
            </Card>
